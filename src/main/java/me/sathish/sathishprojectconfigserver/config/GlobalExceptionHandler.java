...
import me.sathish.sathishprojectconfigserver.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    ProblemDetail onException(Exception exception) {
        if (exception instanceof ResourceNotFoundException resourceNotFoundException) {
            ...
            problemDetail.setType(URI.create("http://api.trackmeditation.com/errors/not-found"));
